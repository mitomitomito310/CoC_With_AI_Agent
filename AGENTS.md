...
- フェーズ開始時、エージェントはまず質問を提示します。できる限り選択肢と推奨案を含めます。
- ユーザーの回答は、そのフェーズの `plan.md` に短く記録します。
- そのフェーズの `plan.md` 以外の成果物は、ユーザーが承認するまで作成・更新しません。
...
| 2. Requirements | `implementation/2_requirements/plan.md` | `requirements.md`, `acceptance_criteria.md`, `risk_notes.md` | 採用案を、実装可能な要件・受け入れ条件・リスクに分解します。 |
